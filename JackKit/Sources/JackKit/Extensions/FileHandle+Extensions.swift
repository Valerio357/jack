...
extension FileHandle {
    ...
    func writeApplicaitonInfo() {
        ...
        header += "Jack Version: \(Bundle.main.infoDictionary?["CFBundleShortVersionString"] ?? "")\n"
    ...
    func writeInfo(for bottle: Bottle) {
        ...
        if let version = JackWineInstaller.whiskyWineVersion() {
            header += "JackWine Version: \(version.major).\(version.minor).\(version.patch)\n"
        }
