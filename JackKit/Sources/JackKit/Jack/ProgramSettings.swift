...
public struct ProgramSettings: Codable {
    ...
    static func decode(from settingsURL: URL, forProgram name: String = "") throws -> ProgramSettings {
        guard FileManager.default.fileExists(atPath: settingsURL.path(percentEncoded: false)) else {
            var settings = ProgramSettings()
            if name.caseInsensitiveCompare("steam.exe") == .orderedSame {
                settings.arguments = "-no-cef-sandbox -cef-disable-sandbox"
            }
