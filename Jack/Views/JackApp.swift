        ...
        WindowGroup {
            ContentView(showSetup: $showSetup)
                ...
                .onAppear {
                    ...
                    Task.detached {
                        await JackApp.deleteOldLogs()
                    }
                }
                .onOpenURL { url in
                    // barrel://auth/callback is normally intercepted by
                    // ASWebAuthenticationSession; this handler is a fallback.
                    guard url.scheme == "barrel" else { return }
                }
        }
        ...
        .commands {
            ...
            CommandGroup(after: .importExport) {
                ...
                Button("wine.clearShaderCaches") {
                    JackApp.killBottles() // Better not make things more complicated for ourselves
                    JackApp.wipeShaderCaches()
                }
            }
            CommandGroup(replacing: .help) {
                ...
                Button("help.github") {
                    if let url = URL(string: "https://github.com/Jack-App/Jack") {
                        openURL(url)
                    }
                }
                Button("help.discord") {
